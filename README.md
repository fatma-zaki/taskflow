...
See **[DEPLOYMENT.md](DEPLOYMENT.md)** for the full walkthrough: two Vercel projects (`client`
and `server`), the environment variables each one needs, Vercel Blob for attachments, and
Vercel Cron for the reminder jobs.
