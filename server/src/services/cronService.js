...
export const startCronJobs = () => {
  // On Vercel nothing runs between requests, so the schedule lives in vercel.json and
  // calls /api/cron/reminders and /api/cron/overdue instead.
  if (process.env.VERCEL) {
    console.log('Serverless environment detected - in-process cron jobs disabled');
    return;
  }
